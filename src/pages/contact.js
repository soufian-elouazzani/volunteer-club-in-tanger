        ...
        <Layout location={location} crumbLabel="Contact">
            ...
            <section>
                <div className="max-w-6xl mx-auto pb-16 px-4 flex flex-col">
                    <p className="text-lg">If you would like to contact the club, please reach out to soufara2.motatawi3@gmail.com. Alternatively, if you feel that contact through social media is more appropriate, you can message any of the following accounts:</p>
